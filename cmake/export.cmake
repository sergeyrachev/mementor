function(configure_export SYMBOLS_SPACE_NAME)
    ...
    configure_file(${CMAKE_CURRENT_BINARY_DIR}/export_configuration.h.in ${CMAKE_CURRENT_BINARY_DIR}/export_configuration.h @ONLY)
    ...
    message(STATUS "Don't forget to add CMAKE_CURRENT_BINARY_DIR (which is ${CMAKE_CURRENT_BINARY_DIR})to your target include directories")
endfunction()
