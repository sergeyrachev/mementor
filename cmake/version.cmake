function(configure_version symbols_space_name)
    ...
    configure_file(${CMAKE_CURRENT_FUNCTION_LIST_DIR}/../res/version.h.in ${CMAKE_CURRENT_BINARY_DIR}/version.h @ONLY)
    configure_file(${CMAKE_CURRENT_FUNCTION_LIST_DIR}/../res/version.cpp.in ${CMAKE_CURRENT_BINARY_DIR}/version.cpp @ONLY)
...
function(configure_birthday symbols_space_name)
    ...
    configure_file(${CMAKE_CURRENT_FUNCTION_LIST_DIR}/../res/birthday.h.in ${CMAKE_CURRENT_BINARY_DIR}/birthday.h)
    configure_file(${CMAKE_CURRENT_FUNCTION_LIST_DIR}/../res/birthday.cpp.in ${CMAKE_CURRENT_BINARY_DIR}/birthday.cpp)
